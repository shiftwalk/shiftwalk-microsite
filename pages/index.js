...
export const revealDownDelay = {
  ...
  enter: { 
    y: 0,
    transition: { duration: 1.5, ease: [0.83, 0, 0.17, 1], delay: 0.5 }
  },
	exit: {
    y: '-110%',
      ...
      <LazyMotion features={domAnimation}>
        ...
        >
          <Div100vh className="flex flex-wrap p-4 md:p-5 text-[18px] leading-[24px] md:text-[20px] md:leading-[27px] xl:text-[24px] xl:leading-[31px] selection:bg-black selection:text-off-grey">
            ...
            <div className={`fixed inset-0 flex items-center justify-center transition ease-in-out duration-500 z-0 ${samHovered || isaacHovered ? 'opacity-0' : 'opacity-100' }`}>
